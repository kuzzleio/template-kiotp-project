...
export class AssetsModule extends Module {
  register(): void {
    ...
    deviceManager.models.registerAsset('asset_tracking', 'Container', containerAssetDefinition);

    deviceManager.models.registerAsset('asset_tracking', 'Truck', truckAssetDefinition);

    deviceManager.models.registerAsset('asset_tracking', 'Warehouse', warehouseAssetDefinition);
  }
}
