  ...
  async loadDigitalTwins() {
    await Promise.all([
      ...
      this.createStreetLamp(
        "StreetLamp",
        "0001",
        { lat: 43.60219, lon: 3.8788 },
        "Rue Colin",
      ),
      this.createStreetLamp(
        "StreetLamp",
        "0002",
        { lat: 43.60188, lon: 3.87876 },
        "Rue Colin",
      ),
      this.createStreetLamp(
        "StreetLamp",
        "0003",
        { lat: 43.60169, lon: 3.8785 },
        "Rue Colin",
      ),
      this.createStreetLamp(
        "StreetLamp",
        "0004",
        { lat: 43.60147, lon: 3.87853 },
        "Rue Colin",
      ),
      this.createStreetLamp(
        "StreetLamp",
        "0005",
        { lat: 43.60123, lon: 3.87821 },
        "Rue Colin",
      ),
      ...
      this.createStreetLamp(
        "StreetLamp",
        "0006",
        { lat: 43.61671, lon: 3.87827 },
        "Rue Lakanal",
      ),
      this.createStreetLamp(
        "StreetLamp",
        "0007",
        { lat: 43.61689, lon: 3.87797 },
        "Rue Lakanal",
      ),
      this.createStreetLamp(
        "StreetLamp",
        "0008",
        { lat: 43.61695, lon: 3.87755 },
        "Rue Lakanal",
      ),
      this.createStreetLamp(
        "StreetLamp",
        "0009",
        { lat: 43.61713, lon: 3.87723 },
        "Rue Lakanal",
      ),
      this.createStreetLamp(
        "StreetLamp",
        "0010",
        { lat: 43.61721, lon: 3.87677 },
        "Rue Lakanal",
      ),
